...
=== Order Placement
- Customers can browse restaurant menus via the app or website.
...
- Dishes can be flagged as unavailable.

=== Customization Options
- Restaurants can customize restaurant appearance, upload photos, address, exact location (pin coordinates), and description.
