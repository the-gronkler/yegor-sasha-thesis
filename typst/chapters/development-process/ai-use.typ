...
The integration of AI into research and development requires strict ethical boundaries to maintain integrity. As a tool, AI was applied under the principle of mandatory human oversight, ensuring that all machine-generated outputs were verified, critiqued, and approved by the authors.
...
*Impact Assessment:*
The integration of AI significantly enhanced the efficiency of the development cycle. Automated code reviews reduced the time spent on syntax and style verification, allowing human reviewers to focus on architectural logic and business requirements.
