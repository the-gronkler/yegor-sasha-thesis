...
The complete commit history of the project, demonstrating the detailed breakdown of individual contributions, is available in the project repository @SourceCodeRepo. It is important to note that commit history and authorship alone do not fully capture the collaborative nature of the project, as line count doesn't reflect the complexity or significance of contributions, and many changes were made collaboratively through code reviews and pair programming sessions.
